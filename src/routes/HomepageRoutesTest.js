...
router.get('/home2', requireAuth, async (req, res) => {
  res.send({
 ...
 */
router.get('/popularRecipes2', requireAuth, async (req, res) => {
 ...
 */
router.get('/recentRecipes2', requireAuth, async (req, res) => {
 ...
 */
router.get('/randomRecipes2', requireAuth, async (req, res) => {
 ...
 */
router.get('/possiblerecipes2', requireAuth, async (req, res) => {
